...
public class StartupSettings {
    ...
    public static final List<String> EXCLUDED_FOLDERS = List.of("windows", "system32", "bin", "etc", "lib", "data", "program files", "program files (x86)", "recovery", "program data");
    ...
    public static int PARALLEL_THREAD_COUNT = 10;
