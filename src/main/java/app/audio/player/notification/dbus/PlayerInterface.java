 ...
 */
@DBusInterfaceName("org.mpris.MediaPlayer2.Quartz")
public interface PlayerInterface extends DBusInterface {
    public static String BUS_NAME = "org.mpris.MediaPlayer2.Quartz";
    public static String PATH = "/org/mpris/MediaPlayer2/Quartz";  void Next();
