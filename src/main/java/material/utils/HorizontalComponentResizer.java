...
public class HorizontalComponentResizer extends MouseAdapter {
    private final static int MINIMUM_SIZE = 100;
    private final static int MAXIMUM_SIZE = Integer.MAX_VALUE;
     ...
     */
    public HorizontalComponentResizer(Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public HorizontalComponentResizer(Insets dragInsets, Component... components) {
     ...
     * @param components components to be automatically registered
     */
    public HorizontalComponentResizer(Insets dragInsets, Dimension snapSize, Component... components) {
     ...
     */
    private void validateMinimumAndInsets(int minimum, Insets drag) {
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current) {
        ...
        if (WEST == (direction & WEST)) {
            ...
            int maximum = Math.min(width + x, maximumSize);
            drag = getDragBounded(drag, snapSize.width, width, minimumSize, maximum);
        ...
        if (EAST == (direction & EAST)) {
            ...
            int maximum = Math.min(boundingSize.width - x, maximumSize);
            drag = getDragBounded(drag, snapSize.width, width, minimumSize, maximum);
            width += drag;
        }
