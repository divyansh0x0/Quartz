...
public class PerlinNoise {
    ...
    private static final int PERSISTENCE = 4; // Number of octaves
    private static final int OCTAVES = 8; // Persistence factor
    ...
    private static final int[] permutation = {151, 160, 137, 91, 90, 15,
            ...
            33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68, 175, 74, 165, 71, 134, 139, 48, 27,
            166, 77, 146, 158, 231, 83, 111, 229, 122, 60, 211, 133, 230, 220, 105, 92, 41, 55, 46, 245, 40,
            244, 102, 143, 54, 65, 25, 63, 161, 1, 216, 80, 73, 209, 76, 132, 187, 208, 89, 18, 169, 200,
            196, 135, 130, 116, 188, 159, 86, 164, 100, 109, 198, 173, 186, 3, 64, 52, 217, 226, 250, 124,
    ...
    private static double grad(int hash, double x, double y, double z) {
        int h = hash & 3;  // Use only the first two bits for horizontal bias
        double u = h < 2 ? x : -x;
        double v = h == 0 || h == 2 ? y : -y;
        return u + v;
    }
}
